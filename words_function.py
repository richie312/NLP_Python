...
def build_coder(shift):
    ...
    alphabets.insert(0,' ')    
    shifted_alpha=alphabets[shift:]+alphabets[:shift]
    for i in range(len(alphabets)):
        dict[alphabets[i]]= shifted_alpha[i]
    return dict
...
apply_coder('This is a test.',build_coder(8))
...
def apply_shifts(text, shifts):
    ...
    """
    """instantiate the empty list for character separated by the location specified in shifts"""
